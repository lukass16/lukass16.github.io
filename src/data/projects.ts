...
export const projects: Project[] = [
  {
    ...
    summary:
      "Research at the Logan Wright Lab, inverse-designing strong trap pulses so that a fiber applies programmable unitary transformations to weak pulses",
    tags: ["ML", "DA"],
    date: "2026-09-15",
    image: "/images/projects/temporal-trapping.png",
    imageCaption: "Inverse-design loop (top) and a weak pulse held by a strong trap pulse in simulation (bottom)",
    links: [
      {
        name: "Code",
...
Full write-up [here](/uploads/documents/nlse/writeup.pdf); code on [GitHub](https://github.com/lukass16/LGW-Lab-NLSE).`,
  },
  {
    slug: "assemblebench",
    title: "AssembleBench",
